...
try:
    with open('./models/svm_pipeline_model.pkl', 'rb') as file:
        model = pickle.load(file)
    st.sidebar.success("Model loaded successfully!")
except FileNotFoundError:
    st.sidebar.error("Model file './models/svm_pipeline_model.pkl' not found. Please train and save the model first.")
    st.stop()
...
try:
    ...
    st.error("Dataset file './data/heart_disease.csv' not found. Please check the path and ensure the file exists.")
    st.stop()
except Exception as e:
